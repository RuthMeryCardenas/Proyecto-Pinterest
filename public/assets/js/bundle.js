...
const myModal = () => {
    ...
    modal.on('show.bs.modal', function (e) {
        ...
        let pin = $(e.relatedTarget);
        console.log(e.relatedTarget);

        let pinId = pin.data('id');
        state.current_pin = pinId;
        /*let modal = $(this);*/
...
const Modal_header = () => {
    ...
    const save_btn = $('<button class="btn btn-danger" type="button"><span' +
        ' class="icon-pin"></span>Guardar</button>');
